package mult32_l4_u5_gznk

import chisel3._
import chisel3.stage.ChiselStage

class mult32_l4_u5_gznk(inData: Int, usrData: Int, stages: Int) extends Module {
...
object mult32_l4_u5_gznk_driver extends App {
  (new ChiselStage).emitVerilog(new mult32_l4_u5_gznk(32, 5, 4), args)
}
